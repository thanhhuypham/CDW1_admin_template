...
<html>
    ...
    <head>
        ...
        $less = new lessc;
        $less->compileFile('less/type-45.less', 'css/type-45.css');
        ?>
        <link href="css/type-45.css" rel="stylesheet" type="text/css" />
        <script src="js/sidebarmenu-left.js" type="text/javascript"></script>
